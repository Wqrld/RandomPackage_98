...
public class EnchantType implements Listener {
	...
	private void pluginEnableEvent(PluginEnableEvent event) {
		...
		swordEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Legendary.Greatsword.Greatsword1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		bowEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Legendary.Sniper.Sniper1.ItemLore").replace(" I", "").replace(" ", ""))));
		/*
		 * Ultimate
		 */
		...
		swordEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Ultimate.Block.Block1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		armorEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Ultimate.CreeperArmor.CreeperArmor1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		toolEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Ultimate.Skilling.Skilling1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		weaponEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Ultimate.Training.Training1.ItemLore").replace(" I", "").replace(" ", ""))));
		bowEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Ultimate.Unfocus.Unfocus1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		swordEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Elite.DeepWounds.DeepWounds1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		armorEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Elite.Frozen.Frozen1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		bootEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Elite.Nimble.Nimble1.ItemLore").replace(" I", "").replace(" ", ""))));
		weaponEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Elite.Poison.Poison1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		chestplateEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Elite.Spirits.Spirits1.ItemLore").replace(" I", "").replace(" ", ""))));
		...
		bowEnchants.add(ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', RandomPackage.getPlugin().getConfig().getString("Enchantments.Elite.Virus.Virus1.ItemLore").replace(" I", "").replace(" ", ""))));
